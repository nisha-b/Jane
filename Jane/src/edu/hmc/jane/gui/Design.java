...
public class Design extends javax.swing.JFrame implements Thread.UncaughtExceptionHandler {
    ...
    private void initComponents() {
        ...
        solution_table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Float.class
            };
    ...
    public String toString() {
        return costEditor.addDecimal(this.value, costEditor.decimal_places);
    }
}
                    ...
                    public void run() {
                        ...
                        if (getCosts(30) == 0) { // At "Set Costs" mode, put cost values in combo boxes
                            ...
                            if (getCosts(18) != 0) {
                                for (int a = 0; a <= getCosts(24); a++) {
                                    cospeciation_jComboBox_stats.addItem(new ComboItem(getCosts(12) + a * getCosts(18)));
                                }
                            } else {
                                cospeciation_jComboBox_stats.addItem(new ComboItem(getCosts(12)));
                            }
                            if (getCosts(19) != 0) {
                                for (int a = 0; a <= getCosts(25); a++) {
                                    duplication_jComboBox_stats.addItem(new ComboItem(getCosts(13) + a * getCosts(19)));
                                }
                            } else {
                                duplication_jComboBox_stats.addItem(new ComboItem(getCosts(13)));
                            }
                            if (getCosts(20) != 0) {
                                for (int a = 0; a <= getCosts(26); a++) {
                                    duplication_host_switch_jComboBox_stats.addItem(new ComboItem(getCosts(14) + a * getCosts(20)));
                                }
                            } else {
                                duplication_host_switch_jComboBox_stats.addItem(new ComboItem(getCosts(14)));
                            }
                            if (getCosts(21) != 0) {
                                for (int a = 0; a <= getCosts(27); a++) {
                                    loss_jComboBox_stats.addItem(new ComboItem(getCosts(15) + a * getCosts(21)));
                                }
                            } else {
                                loss_jComboBox_stats.addItem(new ComboItem(getCosts(15)));
                            }
                            if (getCosts(22) != 0) {
                                for (int a = 0; a <= getCosts(28); a++) {
                                    failure_to_diverge_jComboBox_stats.addItem(new ComboItem(getCosts(16) + a * getCosts(22)));
                                }
                            } else {
                                failure_to_diverge_jComboBox_stats.addItem(new ComboItem(getCosts(16)));
                            }
                            if (getCosts(23) != 0) {
                                for (int a = 0; a <= getCosts(29); a++) {
                                    infestation_jComboBox_stats.addItem(new ComboItem(getCosts(17) + a * getCosts(23)));
                                }
                            } else {
                                infestation_jComboBox_stats.addItem(new ComboItem(getCosts(17)));
                            }
                        }
                        ...
                        try {
                            if (getCosts(30) == 0) { // At "Set Costs" mode
                                ...
                                //costEditor.tuple.setDecimalPlaces(costEditor.decimal_places);
                                            ...
                                            for (int dd = 0; dd < loss_jComboBox_stats.getItemCount(); dd++) {
                                                for (int ee = 0; ee < failure_to_diverge_jComboBox_stats.getItemCount(); ee++) {
                                                    for (int ff = 0; ff < infestation_jComboBox_stats.getItemCount(); ff++) {
                                                        costEditor.tuple.setCospeciationCost((Integer) ((ComboItem) cospeciation_jComboBox_stats.getItemAt(aa)).getValue());
                                                        costEditor.tuple.setDuplicationCost((Integer) ((ComboItem) duplication_jComboBox_stats.getItemAt(bb)).getValue());
                                                        costEditor.tuple.setLossCost((Integer) ((ComboItem) loss_jComboBox_stats.getItemAt(dd)).getValue());
                                                        if (distance.getHostSwitchAllow()) {
                                                            costEditor.tuple.setHostSwitchCost((Integer) ((ComboItem) duplication_host_switch_jComboBox_stats.getItemAt(cc)).getValue());
                                                        } else {
                                                            costEditor.tuple.setHostSwitchCost(INFINITY);
                                                        }
                                                        if (distance.getFailureToDivergeAllow()) {
                                                            costEditor.tuple.setFailureToDivergeCost((Integer) ((ComboItem) failure_to_diverge_jComboBox_stats.getItemAt(ee)).getValue());
                                                        } else {
                                                            costEditor.tuple.setFailureToDivergeCost(INFINITY);
                                                        }
                                                        if (distance.getInfestationAllow()) {
                                                            costEditor.tuple.setInfestationCost((Integer) ((ComboItem) infestation_jComboBox_stats.getItemAt(ff)).getValue());
                                                        } else {
                                                            costEditor.tuple.setInfestationCost(INFINITY);
                                                        }
            ...
            blink = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (getCosts(30) == 0) { // At "Set Costs" mode, put cost values in combo boxes
                        ...
                        if (getCosts(18) != 0) {
                            for (int a = 0; a <= getCosts(24); a++) {
                                cospeciation_jComboBox_solve.addItem(new ComboItem(getCosts(12) + a * getCosts(18)));
                            }
                        } else {
                            cospeciation_jComboBox_solve.addItem(new ComboItem(getCosts(12)));
                        }
                        if (getCosts(19) != 0) {
                            for (int a = 0; a <= getCosts(25); a++) {
                                duplication_jComboBox_solve.addItem(new ComboItem(getCosts(13) + a * getCosts(19)));
                            }
                        } else {
                            duplication_jComboBox_solve.addItem(new ComboItem(getCosts(13)));
                        }
                        if (getCosts(20) != 0) {
                            for (int a = 0; a <= getCosts(26); a++) {
                                duplication_host_switch_jComboBox_solve.addItem(new ComboItem(getCosts(14) + a * getCosts(20)));
                            }
                        } else {
                            duplication_host_switch_jComboBox_solve.addItem(new ComboItem(getCosts(14)));
                        }
                        if (getCosts(21) != 0) {
                            for (int a = 0; a <= getCosts(27); a++) {
                                loss_jComboBox_solve.addItem(new ComboItem(getCosts(15) + a * getCosts(21)));
                            }
                        } else {
                            loss_jComboBox_solve.addItem(new ComboItem(getCosts(15)));
                        }
                        if (getCosts(22) != 0) {
                            for (int a = 0; a <= getCosts(28); a++) {
                                failure_to_diverge_jComboBox_solve.addItem(new ComboItem(getCosts(16) + a * getCosts(22)));
                            }
                        } else {
                            failure_to_diverge_jComboBox_solve.addItem(new ComboItem(getCosts(16)));
                        }
                        if (getCosts(23) != 0) {
                            for (int a = 0; a <= getCosts(29); a++) {
                                        ...
                                        for (int dd = 0; dd < loss_jComboBox_solve.getItemCount(); dd++) {
                                            for (int ee = 0; ee < failure_to_diverge_jComboBox_solve.getItemCount(); ee++) {
                                                for (int ff = 0; ff < infestation_jComboBox_solve.getItemCount(); ff++) {
                                                    costEditor.tuple.setCospeciationCost((Integer) ((ComboItem) cospeciation_jComboBox_solve.getItemAt(aa)).getValue());
                                                    costEditor.tuple.setDuplicationCost((Integer) ((ComboItem) duplication_jComboBox_solve.getItemAt(bb)).getValue());
                                                    costEditor.tuple.setLossCost((Integer) ((ComboItem) loss_jComboBox_solve.getItemAt(dd)).getValue());
                                                    if (distance.getHostSwitchAllow()) {
                                                        costEditor.tuple.setHostSwitchCost((Integer) ((ComboItem) duplication_host_switch_jComboBox_solve.getItemAt(cc)).getValue());
                                                    } else {
                                                        costEditor.tuple.setHostSwitchCost(INFINITY);
                                                    }
                                                    if (distance.getFailureToDivergeAllow()) {
                                                        costEditor.tuple.setFailureToDivergeCost((Integer) ((ComboItem) failure_to_diverge_jComboBox_solve.getItemAt(ee)).getValue());
                                                    } else {
                                                        costEditor.tuple.setFailureToDivergeCost(INFINITY);
                                                    }
                                                    if (distance.getInfestationAllow()) {
    ...
    static class LeftAlignedTableRenderer extends DefaultTableCellRenderer {
        ...
        public void setValue(Object value) {
            ...
            if (value instanceof Integer) {
                ...
                setText((value == null) ? "" : Double.toString(d));
            } else {
